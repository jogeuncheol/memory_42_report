...
## **7.상세 학습 내용**
- **코딩에 사용된 시간** 대략 6시간.
- **참고한 내용** [memmove 참고 글](https://m.blog.naver.com/PostView.nhn?blogId=sharonichoya&logNo=220510332768&proxyReferer=https:%2F%2Fwww.google.com%2F), [bsd man에서 memmove 등 함수 찾아보기](https://www.freebsd.org/cgi/man.cgi?query=memmove&apropos=0&sektion=3&manpath=FreeBSD+12.2-RELEASE&arch=default&format=html), [strchr 사용법](https://hand-over.tistory.com/39)
### ft_memset
- **형식**
...
```
## **8.학습 내용에 대한 개인적인 총평**
본과정의 첫 번째 과제인 Libft 는 라이브러리를 만드는 과제인것으로 알고있다. 아직 Makefile에 대한 공부도 부족하고 piscine 과정에서 헤더 파일에 대해 학습하지 못했던 관계로 먼저 작성 할 수 있는 소스를 작성하고 Makefile과 헤더파일 작성에 시간을 할애하려고 했다.\
